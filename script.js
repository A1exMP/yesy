...
class Player{
    ...
    keyboard(){
        document.addEventListener("keydown",(evt)=>{
            ...
            if(evt.key == "ArrowUp" && this.keys.shoot && !this.keys.A && !this.keys.D && !this.keys.RIGHT && !this.keys.LEFT ){
        ...
        document.addEventListener("keyup",(evt)=>{
            if(evt.key == "a" || evt.key == "A" || evt.key == "ArrowLeft"){
                this.keys.A = false;
                this.keys.LEFT = false;

            }
            if(evt.key == "d" || evt.key == "D" || evt.key == "ArrowRight" ){
                this.keys.D = false;
        ...
        heart.addEventListener("touchstart",()=>{
            ...
            if(!this.keys.D && !this.keys.A && !this.keys.RIGHT && !this.keys.LEFT){
                this.projectiles.push(
                    new Projectile({
                        x:this.position.x+(this.width/2)-5,
                        y:this.position.y-15
